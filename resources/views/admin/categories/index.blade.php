...
@section('page-title', ' Main Category List')
            ...
            <div class="card card-glass">
                <div class="card-body" style="width: 72vw">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
                        <h5 class="card-title mb-3 mb-md-0"><i class="bi bi-tags-fill me-2"></i> Main Categories</h5>
                        <div class="d-flex flex-column flex-md-row align-items-md-center gap-3">
                            <div class="search-box">
                                <i class="bi bi-search"></i>
                                <input type="text" id="customSearch" class="form-control" placeholder="Search...">
                            </div>
                            <a href="{{ route('admin.categories.create') }}" class="btn btn-swippy text-light">
                                <i class="bi bi-plus-circle me-1"></i> Add Main Category
                            </a>
                        </div>
                    </div>
